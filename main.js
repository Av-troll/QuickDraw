var timer_counter = 0; //will keep on incrementing the timer counter value//
var timer_check = ""; //will keep checking the timer value.//
var drawn_sketch = ""; //holds the approximate guess for the sketch you have drawn on the canvas.//
var answer_holder = ""; //holds the value when the drawn sketch and the sketch to be drawn matches.//
var score = 0; //holds the score value for every right sketch drawn.//
...
var Element_of_array = quick_draw_data_set[random_no];

document.getElementById("sketch_name").innerHTML = "The Object to be Drawn Is " + Element_of_array;
